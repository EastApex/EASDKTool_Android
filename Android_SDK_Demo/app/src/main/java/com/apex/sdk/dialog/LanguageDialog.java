...
public class LanguageDialog extends Dialog {
    ...
    public LanguageDialog(@NonNull Context context) {
        ...
        sexData = new String[]{getContext().getResources().getString(R.string.language_default), getContext().getResources().getString(R.string.language_english),
                getContext().getResources().getString(R.string.language_chinese_simplifid), getContext().getResources().getString(R.string.language_chinese_traditional),
                getContext().getResources().getString(R.string.language_francais), getContext().getResources().getString(R.string.language_greek)
        };
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleText.setText(getContext().getString(R.string.language));
