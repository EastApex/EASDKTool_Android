...
public class VibrationModeDialog extends Dialog {
    ...
    public VibrationModeDialog(@NonNull Context context) {
        super(context, R.style.waiteDialog);
        sexData = new String[]{getContext().getResources().getString(R.string.vibration_mode_normal), getContext().getResources().getString(R.string.vibration_mode_strong),
                getContext().getResources().getString(R.string.vibration_mode_week), getContext().getResources().getString(R.string.vibration_mode_not_vibrate)};
    }
