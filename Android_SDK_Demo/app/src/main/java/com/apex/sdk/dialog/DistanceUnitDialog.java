...
public class DistanceUnitDialog extends Dialog {
    ...
    public DistanceUnitDialog(@NonNull Context context) {
        super(context, R.style.waiteDialog);
        sexData = new String[]{getContext().getResources().getString(R.string.distance_unit_kilometre), getContext().getResources().getString(R.string.distance_unit_mile)};
    }
