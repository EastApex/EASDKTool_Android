...
public class MotionTypeDialog extends Dialog {
    ...
    int currentIndex;
    public MotionTypeDialog(@NonNull Context context) {
        super(context, R.style.waiteDialog);
        typeData = context.getResources().getStringArray(R.array.type_sync);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleText.setText(getContext().getString(R.string.data_type));
