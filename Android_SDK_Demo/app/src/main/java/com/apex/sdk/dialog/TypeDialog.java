...
public class TypeDialog extends Dialog {
    ...
    public TypeDialog(@NonNull Context context) {
        ...
        sexData = new String[]{getContext().getResources().getString(R.string.sleep), getContext().getResources().getString(R.string.sport),
                getContext().getResources().getString(R.string.drinking), getContext().getResources().getString(R.string.takeTheMedicine),
                getContext().getResources().getString(R.string.meeting), getContext().getResources().getString(R.string.custom)};
    }
