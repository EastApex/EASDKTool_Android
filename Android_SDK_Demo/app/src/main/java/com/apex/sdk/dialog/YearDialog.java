...
public class YearDialog extends Dialog {
    private int[] ageData = new int[]{2022, 2023, 2024, 2025, 2026, 2027, 2028, 2029};
    ...
    public YearDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleText.setText(getContext().getString(R.string.year));
