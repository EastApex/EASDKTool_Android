...
public class DeviceUnitDialog extends Dialog {
    ...
    public DeviceUnitDialog(@NonNull Context context) {
        super(context, R.style.waiteDialog);
        sexData = new String[]{getContext().getResources().getString(R.string.device_unit_metric), getContext().getResources().getString(R.string.device_unit_imperial)};
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleText.setText(getContext().getString(R.string.equipment_unit));
