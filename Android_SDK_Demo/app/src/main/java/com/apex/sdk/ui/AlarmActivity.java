...
public class AlarmActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        eventList.addItemDecoration(new DefaultItemDecoration(getColor(android.R.color.transparent), getResources().getDisplayMetrics().widthPixels, (int) SizeTransform.dp2px(2, AlarmActivity.this)));
        ...
        eventList.setSwipeMenuCreator(new SwipeMenuCreator() {
            ...
            public void onCreateMenu(SwipeMenu leftMenu, SwipeMenu rightMenu, int position) {
                ...
                SwipeMenuItem deleteItem = new SwipeMenuItem(AlarmActivity.this).setBackground(R.color.dialog_submit_txt_color)
