...
public class SkinDialog extends Dialog {
    ...
    public SkinDialog(@NonNull Context context) {
        ...
        sexData = new String[]{getContext().getResources().getString(R.string.skin_black), getContext().getResources().getString(R.string.skin_white),
                getContext().getResources().getString(R.string.skin_white_yellow), getContext().getResources().getString(R.string.skin_yellow_black), getContext().getResources().getString(R.string.skin_yellow)};
    }
