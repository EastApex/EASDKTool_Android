...
public class TimeZoneDialog extends Dialog {
    ...
    public TimeZoneDialog(@NonNull Context context) {
        ...
        sexData = new String[]{getContext().getResources().getString(R.string.eastern_time_zone), getContext().getResources().getString(R.string.west_time_zone), getContext().getResources().getString(R.string.zero_time_zone)};
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleText.setText(getContext().getString(R.string.time_zone));
