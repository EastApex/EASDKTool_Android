...
public class DeviceActionDialog extends Dialog {
    ...
    public DeviceActionDialog(@NonNull Context context) {
        super(context, R.style.waiteDialog);
        sexData = new String[]{getContext().getResources().getString(R.string.device_action_bright_screen), getContext().getResources().getString(R.string.device_action_rest_screen),
                getContext().getResources().getString(R.string.device_action_restore), getContext().getResources().getString(R.string.device_action_restart)
        };
    }
