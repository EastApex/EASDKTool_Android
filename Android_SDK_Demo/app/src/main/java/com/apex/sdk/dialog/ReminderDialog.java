...
public class ReminderDialog extends Dialog {
    ...
    public ReminderDialog(@NonNull Context context) {
        ...
        sexData = new String[]{getContext().getResources().getString(R.string.drinking),  getContext().getResources().getString(R.string.Hand_washing)};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleText.setText(getContext().getString(R.string.Add_reminder));
