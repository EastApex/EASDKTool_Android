...
public class WeightUnitDialog extends Dialog {
    ...
    public WeightUnitDialog(@NonNull Context context) {
        super(context, R.style.waiteDialog);
        sexData = new String[]{getContext().getResources().getString(R.string.weight_unit_kilogram), getContext().getResources().getString(R.string.weight_unit_pound)};
    }
