...
public class SleepBloodMonitorReportTimeDialog extends Dialog {
    private int[] ageData = new int[]{30, 45, 60, 90, 120};
    private WheelView wheelView;
    private AppCompatButton cancel, submit;
    private SelectListener selectListener;
    private TextView titleText;
    int currentIndex;
    public SleepBloodMonitorReportTimeDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleText.setText(getContext().getString(R.string.age));
