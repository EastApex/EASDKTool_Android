...
public class SwitchDialog extends Dialog {
    ...
    public SwitchDialog(@NonNull Context context) {
        ...
        sexData = new String[]{getContext().getResources().getString(R.string.switch_state_close), getContext().getResources().getString(R.string.switch_state_on)};
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleText.setText(getContext().getString(R.string.on_or_off));
