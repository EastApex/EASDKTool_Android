...
public class ModeDialog extends Dialog {
    ...
    public ModeDialog(@NonNull Context context) {
        ...
        sexData = new String[]{getContext().getResources().getString(R.string.general_sync), getContext().getResources().getString(R.string.sync_to_movement)};
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleText.setText(getContext().getString(R.string.sync_mode));
