...
public class CupDialog extends Dialog {
    private int[] ageData = new int[]{1, 2, 3, 4, 5, 6, 7, 8};
    ...
    public CupDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleText.setText(getContext().getString(R.string.Cup));
