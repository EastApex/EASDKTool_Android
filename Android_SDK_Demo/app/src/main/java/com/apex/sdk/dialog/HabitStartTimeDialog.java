...
public class HabitStartTimeDialog extends Dialog {
    ...
    public HabitStartTimeDialog(@NonNull Context context, @NonNull String title) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.dialog_habit_start, null, false);
        setContentView(view);
