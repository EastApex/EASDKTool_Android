...
public class HeightDialog extends Dialog {
    private int[] ageData = new int[]{120, 130, 140, 150, 160, 170, 180, 190};
    ...
    public HeightDialog(@NonNull Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleText.setText(getContext().getString(R.string.height));
