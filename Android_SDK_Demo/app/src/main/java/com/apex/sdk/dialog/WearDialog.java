...
public class WearDialog extends Dialog {
    ...
    public WearDialog(@NonNull Context context) {
        super(context, R.style.waiteDialog);
        sexData = new String[]{getContext().getResources().getString(R.string.left), getContext().getResources().getString(R.string.right)};
    }
