...
public class HourSystemDialog extends Dialog {
    ...
    public HourSystemDialog(@NonNull Context context) {
        super(context, R.style.waiteDialog);
        sexData = new String[]{getContext().getResources().getString(R.string.twelve_hour_system), getContext().getResources().getString(R.string.twenty_four_hour_system)};
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleText.setText(getContext().getString(R.string.hour_system));
